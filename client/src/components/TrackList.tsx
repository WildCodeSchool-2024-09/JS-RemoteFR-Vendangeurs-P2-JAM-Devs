...
function TrackList({
  ...
  return (
    <li className="text-primary flex justify-between items-center gap-y-8 gap-x-4 laptop:gap-20 border-secondary-250 border-b-2 w-full max-w-[800px] p-4 laptop:py-6 laptop:px-8 hover:bg-primary/5">
